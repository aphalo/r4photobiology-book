...
% Some font changes
\setkomafont{title}{\sffamily\mdseries\LARGE}
...
\subtitle{Draft, 60\% done}

\author{Pedro J. Aphalo,\\ Andreas Albert\\ T. Matthew Robson\\ and\\ Titta Kotilainen}

\date{Helsinki, \today}

\publishers{Available through \href{https://leanpub.com/learnr}{Leanpub}}
