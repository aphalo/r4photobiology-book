...
%%% We use OTF fonts through XeLaTeX
...
\AddLayersToPageStyle{headings}{chapterthumb}
\addtokomafont{chapterthumb}{\bfseries}
\renewcommand*{\chapterthumbwidth}{.036\paperheight}
\renewcommand*{\chapterthumbskip}{.034\paperheight}
...
\newcommand\typiattn{\typicons{"E136}}
\newcommand\Attention[1]{\marginpar{\centering\Huge\colorbox{yellow}{\typicons{"E136}}}\index{#1}}
\newcommand\ilAttention{\colorbox{yellow}{\Huge\typicons{"E136}}\xspace}
\newcommand\Advanced[1]{\marginpar{\centering\Huge\colorbox{black}{\textcolor{white}{\typicons{"E04E}}}}\index{#1}}
...
\usepackage[unicode,hyperindex,bookmarks,pdfview=FitB,%backref,
            ...
            pdfkeywords={photobiology, R, spectrum, data analysis, plotting},%
            pdfsubject={Photobiology},%
            pdfauthor={Pedro J. Aphalo, Andreas Albert, T. Matthew Robson, Titta Kotilainen}%
            ]{hyperref}
...
\extratitle{A handbook of theory and recipes}

\title{R for Photobiology}

\subtitle{Theory and recipes for common calculations}

\author{Pedro J. Aphalo \and Andreas Albert \and T. Matthew Robson \and Titta Kotilainen}

\date{Helsinki, \today}

\publishers{Available through \href{https://leanpub.com/r4photobiology}{Leanpub}}

\uppertitleback{\copyright\ 20012--2016 by the authors\\
...
The manuscript was written using \href{http://www.r-project.org/}{R} with package \pckg{knitr}. The manuscript was edited in \href{http://www.winedt.com/}{WinEdt} and \href{http://www.rstudio.com/}{RStudio}.
...
incl_acq <- TRUE || incl_all
incl_data <- TRUE || incl_all
eval_diag <- FALSE
@
...
<<child-photochemistry, child='physics-theory.Rnw', eval=incl_chaps>>=
@
...
\part{Data acquisition and exchange}
