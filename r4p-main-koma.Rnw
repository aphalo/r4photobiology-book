...
\linespread{1.05} % increase line spacing as we use in-line math and code
...
%\usepackage{hyperref}
\usepackage[unicode,hyperindex,bookmarks,pdfview=FitB,colorlinks,%backref,
...
\uppertitleback{\copyright\ 20012--2018 by the authors\\
...
opts_chunk$set(fig.path='figure/pos-', fig.align='center', fig.show='hold', size="footnotesize", dev='pdf', cache=FALSE) #, dev='cairo_pdf'
