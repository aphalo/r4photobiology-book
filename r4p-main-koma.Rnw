\documentclass[paper=a4,headsepline,BCOR=12mm,DIV=15,twoside,open=right,%
...
\publishers{Draft, 60\% done\\Available through \href{https://leanpub.com/learnr}{Leanpub}}
