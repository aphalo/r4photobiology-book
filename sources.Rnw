...
%%%%
\section{Data: extraterrestrial solar radiation spectra}\label{sec:}


%%%%
\section{Data: terrestrial  solar radiation spectra}\label{sec:}
...
\section{Data: incandescent lamps}\label{sec:}

%%%%
\section{Data: discharge lamps}\label{sec:}

%%%%
\section{Data: LEDs}\label{sec:}
