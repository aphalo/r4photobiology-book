...
Using data table syntax, adding the result to the \code{data.table} object:
...
<<>>=
trim_spct(sun.spct, UVA())
trim_spct(sun.spct, UVA(), fill=0)
...
interpolate_spct(sun.spct, seq(400, 420, by=0.1), fill=NA)
@
