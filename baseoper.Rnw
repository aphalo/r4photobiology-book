...
As a second example we compute the logarithm of the spectral energy irradiance.
...
<<>>=
nrow(sun.spct)
nrow(filters.mspct$GG400)
nrow(sun.spct * filters.mspct$GG400)
@
