...
ggplot(my_leds_450.spct) + aes(linetype = LED) + stat_wb_mean(w.band = PAR(), alpha = 0.1) + geom_line() + theme_bw() + theme(legend.position="top") + scale_fill_identity() + scale_color_identity()
@
