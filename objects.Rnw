...
%%%%
\section{Data: spectral transmittance of filters}\label{sec:trans:filters}

%%%%
\section{Data: spectral reflectance of filters}\label{sec:refl:filters}

%%%%
\section{Data: spectral transmittance of common materials}\label{sec:trans:materials}

%%%%
\section{Data: spectral reflectance of common materials}\label{sec:refl:materials}
