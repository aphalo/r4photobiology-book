...
<<astro-geocode-2a, message=FALSE, cache=TRUE>>=
day_night(ymd("2013-12-21"),
          lon = geo_code_BA[["lon"]],
          lat = geo_code_BA[["lat"]],
          tz = "America/Argentina/Buenos_Aires",
...
<<astro-geocode-A2, message=FALSE, cache=TRUE>>=
day_night(ymd("2013-12-21"),
          lon = geo_code_BA[["lon"]],
          lat = geo_code_BA[["lat"]],
          tz = "America/Argentina/Buenos_Aires")
...
<<astro-geocode-A2a, message=FALSE, cache=TRUE>>=
day_night(ymd("2013-12-21"),
          lon = geo_code_BA[["lon"]],
          lat = geo_code_BA[["lat"]],
          tz = "America/Argentina/Buenos_Aires",
...
<<astro-geocode-10a, message=FALSE, cache=TRUE>>=
geo_code_He <- geocode("Helsinki")
daylengths_hel <-
  data.frame(day = days,
...
<<astro-geocode-10b, message=FALSE, cache=TRUE>>=
...
<<astro-geocode-10c, message=FALSE, cache=TRUE>>=
...
<<astro-geocode-11a, message=FALSE, cache=TRUE>>=
geo_code_He <- geocode("Helsinki")
sunrise_hel <-
  data.frame(day = days,
...
<<astro-geocode-11b, message=FALSE, cache=TRUE>>=
geo_code_Iv <- geocode("Ivalo")
sunrise_ivalo <-
  data.frame(day = days,
             sunrise = sunrise_time(days,
...
<<astro-geocode-11c, message=FALSE, cache=TRUE>>=
geo_code_At <- geocode("Athens, Greece")
sunrise_athens <-
  data.frame(day = days,
             sunrise = sunrise_time(days,
...
<<astro-geocode-11d, message=FALSE, cache=TRUE>>=
