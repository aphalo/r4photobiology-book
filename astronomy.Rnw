...
<<>>=
sunrise_time(today(tzone = "UTC"), lat = 60, lon = 0, tz = "UTC")
sunrise_time(today(tzone = "Europe/Helsinki"), lat = 60, lon = 25, tz = "Europe/Helsinki")
sunrise_time(today(tzone = "Europe/Helsinki"), lat = 60, lon = 25, tz = "UTC")
@
...
<<>>=
sunrise_time(today(tzone = "UTC"), lat = 60, lon = 0, tz = "UTC")
sunset_time(today(tzone = "UTC"), lat = 60, lon = 0, tz = "UTC")
noon_time(today(tzone = "UTC"), lat = 60, lon = 0, tz = "UTC")
@
...
<<>>=
day_night(today(tzone = "UTC"), lat = 60, lon = 0, tz = "UTC")
@
...
<<astro-geocode-10a, message=my.debug, cache=cache>>=
...
<<astro-geocode-10b, message=my.debug, cache=cache>>=
...
<<astro-geocode-10c, message=my.debug, cache=cache>>=
...
<<astro-geocode-11a, message=my.debug, cache=cache>>=
geo_code_He <- geocode("Helsinki")
sunrise_hel <-
  data.frame(day = days,
...
<<astro-geocode-11b, message=my.debug, cache=cache>>=
geo_code_Iv <- geocode("Ivalo")
sunrise_ivalo <-
  data.frame(day = days,
             sunrise = sunrise_time(days,
...
<<astro-geocode-11c, message=my.debug, cache=cache>>=
geo_code_At <- geocode("Athens, Greece")
sunrise_athens <-
  data.frame(day = days,
             sunrise = sunrise_time(days,
...
<<astro-geocode-11d, message=my.debug, cache=cache>>=
