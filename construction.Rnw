...
\subsection{Task: Constructing \texttt{\_multi\_spct} objects}

\subsection{Task: Retrieving \texttt{\textunderscore spct} objects}

\subsection{Task: Subsetting \texttt{\_multi\_spct} objects}
