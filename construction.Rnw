...
For spectra the classes are a specialization of \code{data.frame}. This means that they are compatible with functions that operate on objects of this class.
