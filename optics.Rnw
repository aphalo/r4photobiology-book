...
\chapter{Radiation physiscs}\label{chap:optics}
...
\begin{figure*}[htbp]
%\centerline{\includegraphics[width=0.8\myfigwidth]{figures/fig_sun}}%sun.jpg
...
\begin{figure*}
%    \includegraphics[width=\myfigwidth]{photos/Lasse_sky_composite}
...
\begin{figure*}
  \centering
%    \includegraphics[width=0.8\myfigwidth]{figures/fig_diffuse_TUV}
...
\begin{figure*}
%    \includegraphics[width=0.8\myfigwidth]{figures/fig000_norm_AMs}
...
\begin{figure*}
%    \includegraphics[width=0.8\myfigwidth]{figures/fig0_depl_norm_09UTC}
...
\begin{figure*}
%  \includegraphics[width=0.8\myfigwidth]{figures/fig1_depl_norm_log_am}
...
\begin{figure*}
%\includegraphics[width=0.4\myfigwidth]{figures/fig_diffuse_Flint}\
%\includegraphics[width=0.4\myfigwidth]{figures/fig_seasonal_Brown}
...
\begin{figure*}
%  \includegraphics[width=0.8\myfigwidth]{figures/fig_UVB_PAR_Erlangen}\\
%  \includegraphics[width=0.8\myfigwidth]{figures/fig_UVB_Erlangen}
...
\begin{figure*}
%  \includegraphics[width=0.8\myfigwidth]{figures/fig_UVB_latitude}
...
\section{Radiation within plant canopies}
