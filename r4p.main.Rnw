...
\usepackage{calc,soul}%,graphicx,fourier
...
A handbook}}\par
\vspace{\drop}
{\Large Pedro J. Aphalo,\\ Andreas Albert\\ T. Matthew Robson\\ and\\ Titta Kotilainen}\par
\vfill
...
%\loadglsentries[acronym]{gp_acronyms}
\makeglossaries
