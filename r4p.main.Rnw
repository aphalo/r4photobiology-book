...
<<child-optics, child='optics.Rnw', eval=TRUE>>=
@

<<child-photochemistry, child='photochemistry.Rnw', eval=TRUE>>=
@

<<child-software, child='software.Rnw', eval=TRUE>>=
@
...
<<child-uwirrad, child='uwirrad.Rnw', eval=TRUE>>=
@

<<child-wtirrad, child='wtirrad.Rnw', eval=TRUE>>=
@

<<child-colour, child='colour.Rnw', eval=TRUE>>=
@

<<child-photoreceptors, child='photoreceptors.Rnw', eval=TRUE>>=
@

<<child-sources, child='sources.Rnw', eval=TRUE>>=
@

<<child-filters, child='filters.Rnw', eval=TRUE>>=
@

<<child-plots, child='plots.Rnw', eval=TRUE>>=
@

<<child-calibration, child='calibration.Rnw', eval=TRUE>>=
@

<<child-simulation, child='simulation.Rnw', eval=TRUE>>=
@

<<child-measurement, child='measurement.Rnw', eval=TRUE>>=
@

<<child-performance, child='performance.Rnw', eval=TRUE>>=
@
