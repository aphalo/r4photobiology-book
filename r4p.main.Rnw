...
\newlistof{listofexamples}{xpl}{\listexamplename}
\newfloat[chapter]{example}{xpl}{\examplename}
\newlistentry{example}{xpl}{0}
...
<<child-astronomy, child='astronomy.Rnw', eval=FALSE>>=
@
...
<<child-filters, child='filters.Rnw', eval=incl_data>>=
@

<<child-photoreceptors, child='photoreceptors.Rnw', eval=incl_data>>=
@
