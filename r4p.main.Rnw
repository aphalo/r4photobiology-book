...
\usepackage[footinfo]{gitinfo} % remember to setup Git hooks
...
\vfill
{\footnotesize Git \gitVtag of \gitAuthorIsoDate by\ \gitAuthorName \\Printed \today\\ \copyright\ 2013-2014 by the authors}\par
\vspace*{\drop}
\endgroup}
...
<<libraries, eval=FALSE, include=FALSE, cache=FALSE>>=
library(ggplot2)
# library(ggmap)
# library(gtern)
...
<<child-r-scripts, child='R.plotting.Rnw', eval=incl_apdx>>=
@
