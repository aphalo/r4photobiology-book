...
<<>>=
with(sun.data, split_energy_irradiance(w.length, s.e.irrad, c(400,500,600,700), scale="percent"))
@

<<>>=
with(sun.data, split_energy_irradiance(w.length, s.e.irrad, c(400,500,600), scale="percent"))
@
