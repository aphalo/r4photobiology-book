...
<<plot-sun-linear-0>>=
fig_sun.e0 <- ggplot(data = sun.spct, 
...
%%%%
\subsection{Task: annotating wavebands and wavelengths}\label{sec:plot:ann:wband}
...
sTHIS SECTION NEEDS TO BE RE-WRITTEN USING CURRENT VERSION OF 
