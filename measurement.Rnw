...
<<oo-io-01>>=
ooss.spct <- read_ooss_file("inout/spectrum.SSIrrad")
ooss.spct
@

The function accepts several optional arguments. Although the function by default attempts to
read all information from the files, values like the date can be overridden. It also possible
to select a range of wavelengths.

<<oo-io-02>>=
ooss1.spct <- read_ooss_file("inout/spectrum.SSIrrad",
                            range = c(300, 800),
                            date = today())
ooss1.spct
@
...
<<oojz-io-01>>=
jaz.spct <- read_oojaz_file("inout/spectrum.JazIrrad")
jaz.spct
@
...
<<oojz-io-02>>=
jaz1.spct <- read_oojaz_file("inout/spectrum.JazIrrad",
                            range = c(300, 800),
                            date = today())
jaz1.spct
@
...
<<macam-io-01>>=
macam.spct <- read_macam_file("inout/spectrum.DTA")
macam.spct
@
...
<<macam-io-02>>=
macam1.spct <- read_macam_file("inout/spectrum.DTA",
                            range = c(300, 600),
                            date = today())
macam1.spct
@
...
<<li-io-01>>=
licor.spct <- read_licor_file("inout/spectrum.PRN")
licor.spct
@
...
<<li-io-02>>=
licor1.spct <- read_licor_file("inout/spectrum.PRN",
                            range = c(350, 800),
                            date = today())
licor1.spct
@
